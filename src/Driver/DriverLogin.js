        ...
        <form onSubmit={handleSubmit}>
            <div className={`form-inner ${isChangePasswordOpen ? 'blur-background' : ''}`}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" id="username" name="username" onChange={handleInput} value={values.username} autoComplete="off"/>
                    {error.username && <span className="text-danger">{error.username}</span>}
                </div>
                <div className="form-group">
                    <label htmlFor="password"><strong>Password</strong></label>
                    <input type="password" id="password" name="password" onChange={handleInput} value={values.password}/>
